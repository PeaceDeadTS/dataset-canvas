                  ...
                  <div className="overflow-x-auto">
                    ...
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="min-w-[20rem] max-w-[34rem]">Image Key</TableHead>
                        <TableHead className="min-w-[30rem] max-w-[80rem]">Filename</TableHead>
                        <TableHead className="min-w-[30rem] max-w-[80rem]">Image</TableHead>
                        <TableHead className="w-20">Dimensions</TableHead>
                        <TableHead className="min-w-[40rem]">Prompt</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {images.map((image) => (
